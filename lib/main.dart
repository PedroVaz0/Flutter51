...
class _AgendamentoEventoTelaState extends State<AgendamentoEventoTela> {
  ...
  late TimeOfDay _horarioSelecionada;
  ...
  void _resetarValores() {
    setState(() {
      ...
      _horarioSelecionada = _horarioPadrao;
  ...
  void _salvarFormulario() {
    ...
    print('Horário: ${_horarioSelecionada.format(context)}');
  ...
  Future<void> _selecionarData(BuildContext context) async {
    final TimeOfDay? horario = await showTimePicker(
      context: context,
      initialTime: _horarioSelecionada,
    );
    if (horario != null && horario != _horarioSelecionada) {
      setState(() {
        _horarioSelecionada = horario;
      });
      print(
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    label: Text(_horarioSelecionada.format(context)),
                    onPressed: () => _selecionarData(context),
                  ),
                ),
              ],
